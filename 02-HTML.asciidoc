...
You want to make use of Internet Explorer HTML conditional comments(((HTML conditional comments)))((("Internet Explorer, conditional comments"))) in your pass:[<phrase role='keep-together'>templates.</phrase>]
