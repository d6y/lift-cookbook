...
https://developers.google.com/speed/docs/best-practices/caching[Google's "Optimize caching" notes] are a good source of information about browser pass:[<phrase role='keep-together'>behaviour.</phrase>]
