...
You can learn more about URL rewriting at the http://bit.ly/1abV4x2[Lift wiki]. Rewriting is used rarely, and only for special cases. Most problems that look like rewriting problems are better solved with a http://bit.ly/10iHiHb[Menu Param].
