...
You want to make an HTTP POST from a native iOS device to a Lift REST service.((("REST web services", "native iOS applications and")))(((HTTP POSTs)))(((iOS applications)))
