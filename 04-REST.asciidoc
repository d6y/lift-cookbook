...
When submitting an email address to a REST service, a domain ending _.com_ is stripped before your REST service can handle the request.((("REST web services", "preserving .com URL endings")))((("URLs", "preserving .com endings")))
