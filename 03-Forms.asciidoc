...
For more details about the form serialisation process, take a look at http://api.jquery.com/serialize/[the jQuery documentation].
...
The Typeahead widget is http://twitter.github.io/bootstrap/javascript.html#typeahead[documented] as part of Twitter Bootstrap.(((Typeahead component)))
