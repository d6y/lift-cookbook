...
You want to process a form via Ajax, sending the data in JSON format.((("forms processing", "Ajax JSON format", id="ix_FPajxjson", range="startofrange")))(((JSON format, form processing in)))
...
The first `JsonCmd` is unchanged. The second matches on the parameters sent and results in updating the form fields with an upper- or lowercase version of the motto.(((range="endofrange", startref="ix_FPajxjson")))
