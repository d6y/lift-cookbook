...
For more details about the form serialisation process, take a look at http://api.jquery.com/serialize/[the jQuery pass:[<span class='keep-together'>documentation</span>]].
...
http://bit.ly/198JaCB[_Dive into HTML5_] describes how to detect browser pass:[<span class='keep-together'>features.</span>]
...
One peculiarity of the `AutoComplete` widget is that if you type in a new value--one not suggested--and press submit, it is not sent to the server.  That is, you need to click on one of the suggestions to select it.  If that's not the behaviour you want, you can pass:[<span class='keep-together'>adjust it.</span>](((autocomplete suggestions, new values and)))((("S.", "appendJs")))
