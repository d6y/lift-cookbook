...
Form serialisation is described at http://api.jquery.com/serialize/[http://api.jquery.com/serialize/].
...
, describes how to detect browser pass:[<phrase role='keep-together'>features.</phrase>]
...
The HTML5 date input types submit dates in RFC 3339 format. These are specified at http://tools.ietf.org/html/rfc3339[http://tools.ietf.org/html/rfc3339]
