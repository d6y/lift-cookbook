...
Notice in `render` we are binding a regular `SHtml.text` field to the element with the ID of `birthday`, but also appending JavaScript to the page.  That JavaScript selects the `birthday` input field and attaches a configured date picker to it.((("S.", "appendJs")))
