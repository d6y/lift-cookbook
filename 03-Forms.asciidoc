...
them to select multiple values.((("forms processing", "mulitple selections", id="ix_FPmulval", range="startofrange")))(((multiple selections)))(((select boxes)))(((checkboxes, multiple options)))
