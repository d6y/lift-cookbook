...
Use a JavaScript autocomplete widget, for example the jQuery UI autocomplete via the `AutoComplete` class from the Lift Widgets module.(((jQuery UI autocomplete)))
