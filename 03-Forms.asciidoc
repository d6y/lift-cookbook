...
them to select multiple values.((("forms processing", "mulitple options", id="ix_FPmulval", range="startofrange")))(((multiple options)))(((checkboxes, multiple options)))(((select boxes)))
