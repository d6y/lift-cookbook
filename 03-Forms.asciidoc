...
You want to provide an autocomplete widget, to give users suggestions as they type into a text field.((("forms processing", "autocomplete suggestions", id="ix_FPauto", range="startofrange")))
...
The jQuery UI Autocomplete widget is documented http://jqueryui.com/autocomplete/[here]. The version included with the Lift widgets module is version 1.0.2.(((range="endofrange", startref="ix_FPauto")))
