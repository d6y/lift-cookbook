...
Beanstalks enables _auto scaling_ by default. That is, it launches a single instance of your Lift application, but if the load increases above a threshold, up to four instances may be running.(((auto scaling)))((("Lift applications", "autoscaling of")))(((Lift Web Framework, stateful features of)))
