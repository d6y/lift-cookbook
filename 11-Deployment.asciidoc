...
CloudBees has provided https://developer.cloudbees.com/bin/view/Main/Finding+out+app+port+and+hostname[documentation on how to do this]. To get the public hostname, you need to make an HTTP request to _http://instance-data/latest/meta-data/public-hostname_. For example:
...
Amazon provided a http://docs.amazonwebservices.com/elasticbeanstalk/latest/dg/GettingStarted.Walkthrough.html[walkthrough with screenshots], showing how to create a Beanstalk application.
