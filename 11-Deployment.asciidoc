...
You want to run your Lift application on Amazon Web Services (AWS) Elastic Beanstalk.((("production deployments", "to Amazon Web Services A(AWS) Elastic Beanstalk")))
