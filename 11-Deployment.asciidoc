...
You want to deploy your Lift application to your account on the Heroku cloud platform.((("production deployments", "to Heroku", id="ix_PDhero", range="startofrange")))((("Heroku", id="ix_hero", range="startofrange")))(((WAR files)))(((files, WAR files)))
