...
You want to deploy your Lift application to your account on the Heroku cloud platform.((("production deployments", "to Heroku", id="ix_PDhero", range="startofrange")))
