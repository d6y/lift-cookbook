...
Second, if you are using Lift Comet features, there's an adjustment to make in _Boot.scala_ to work a little better in the Heroku environment(((Comet, and Heoku))):
