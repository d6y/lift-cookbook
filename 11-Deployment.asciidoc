...
You use Lift's Comet support, and want to run across multiple servers for increased redundancy or to handle increased load.(((Comet, and muliple servers)))(((redundancy)))
