...
The way Heroku deals with Comet long-polling is described https://devcenter.heroku.com/articles/request-timeout[here].(((range="endofrange", startref="ix_PDhero")))(((range="endofrange", startref="ix_hero")))(((range="endofrange", startref="ix_HOSThero")))
