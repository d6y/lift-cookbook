...
You want to write unit tests to run against your Lift Record code with MongoDB.((("MongoDB", "unit tests")))(((Specs2 unit tests)))((("unit tests", "with Specs2")))
...
IntelliJ IDEA detects and allows you to run Specs2 tests automatically.  With Eclipse, you'll need to include the JUnit runner annotation at the start of your specification((("IntelliJ IDEA development environment")))(((Lift applications, IntelliJ IDEA development))):
