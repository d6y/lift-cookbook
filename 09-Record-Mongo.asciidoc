...
You want to write unit tests to run against your Lift Record code with MongoDB.((("MongoDB", "unit tests", id="ix_MDBunit", range="startofrange")))(((Specs2 unit tests)))((("unit tests", "with Specs2")))
