...
You want to store latitude and longitude information in MongoDB.((("MongoDB", "latitude/longitude information")))((("latitude/longitude information")))(((location information)))(((geospatial values)))
