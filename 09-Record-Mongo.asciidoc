...
You want to use Foursquare's type-safe domain specific language (DSL), Rogue, for querying and updating MongoDB records.((("MongoDB", "querying/updating records")))((("records", "querying/updating")))(((type-safe options)))(((Foursquare)))((("Foursquare's domain-specific language (DSL)")))
