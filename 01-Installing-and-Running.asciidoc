...
Tutorials for Lift can be found in _Simply Lift_ at http://simply.liftweb.net/[http://simply.liftweb.net/] and in _Lift in Action_, Tim Perrett (Manning Publications Co).
...
Use the "Scala IDE for Eclipse" plugin to Eclipse, and the _sbteclipse_ plugin for SBT.  This will give Eclipse the ability to understand Scala, and SBT the ability to create project files that Eclipse can load.
...
There are other useful settings for _sbteclipse_, described at https://github.com/typesafehub/sbteclipse/wiki[https://github.com/typesafehub/sbteclipse/wiki].  You'll also find the latest version number for the plugin on that site.
...
The _sbt-idea_ plugin at https://github.com/mpeltonen/sbt-idea[https://github.com/mpeltonen/sbt-idea] doesn't have a configuration guide yet. One way to discover the features is to browse the release notes in the _notes_ folder of that project.

JetBrains has a blog for the Scala plugin with feature news and tips: http://blog.jetbrains.com/scala/[http://blog.jetbrains.com/scala/].
...
you would like to use a tool to look at the tables.
...
Binary compatibility in Scala is discussed on the Scala user mailing list at
