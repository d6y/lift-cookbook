...
* Visit http://liftweb.net/download[http://liftweb.net/download] and download the Lift 2.5-M4 ZIP file.
* Unzip the file.
...
* Visit http://liftweb.net/download[http://liftweb.net/download] locate the link to the ZIP version of Lift 2.5-M4 and save this to disk.
