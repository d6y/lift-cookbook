...
* Visit http://liftweb.net/download[http://liftweb.net/download] and download the latest Lift 2.5 ZIP file.
* Unzip the file.
...
* Visit http://liftweb.net/download[http://liftweb.net/download] locate the link to the latest ZIP version of Lift 2.5 and save this to disk.
