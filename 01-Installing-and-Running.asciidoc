...
You may want to create a Lift web project from scratch without using the ZIP files provided on the official Lift website.
...
http://bit.ly/10iFg9Q[The example Lift project for <<Squeryl>>] has the H2 console pass:[<phrase role='keep-together'>enabled.</phrase>]
