...
You will need to configure SBT and the Lift project yourself. Luckily, only five small files are needed.((("Simple Build Tool (SBT)", "configuration of")))(((Lift applications, configuration of)))
