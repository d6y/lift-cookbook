...
Binary compatibility in Scala is discussed on the http://article.gmane.org/gmane.comp.lang.scala.user/39290[Scala user mailing list].(((binary compatibility)))
