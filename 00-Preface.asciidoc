...
Follow https://twitter.com/liftcookbook[@LiftCookbook] on Twitter.((("Lift Cookbook", "updates for")))

=== Software Versions

Except where otherwise indicated, the examples use Lift 2.5 with SBT
0.12 and Scala 2.9.((("Lift Cookbook", "software versions used in")))
...
The following typographical conventions are used in this book((("Lift Cookbook", "typographical conventions used"))):
