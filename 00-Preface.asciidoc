...
These recipes existing because of the innumerable contributions on the Lift mailing list, where _Liftafarians_, as they are known, generously give their time to ask  questions, put together simple example projects, give answers, share alternatives and chip in with comments.
