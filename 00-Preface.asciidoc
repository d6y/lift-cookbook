...
I've mined the Lift mailing list for these recipes, but I'm not the only one.  Recipes have been contributed by((("Lift Cookbook", "contributers")))(((contributers, to Lift Cookbook))):
