...
http://www.artima.com/pins1ed/extractors.html[Chapter 24: _Extractors_] from _Programming in Scala_.
...
formulating a new URL that starts _https_ and appends to it the rest of the
