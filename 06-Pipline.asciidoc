...
want to explain why.(((request pipeline, access controlled files)))(((files, access control to)))(((controlled access)))(((access control)))

Solution
^^^^^^^^

Use `RestHelper` to serve the file or an explanation page.(((RestHelper)))(((error messages, file access)))
