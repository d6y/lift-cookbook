...
You want to write Specs2 unit tests that access your database model with Squeryl and Record.((("Record-Squeryl Lift applications", "testing with Specs", id="ix_RSLAtws", range="startofrange")))
