...
You want to configure your Lift application to use Squeryl and Record.((("Lift applications", "Squeryl-Record configuration", seealso="Record-Squeryl Lift applications")))
