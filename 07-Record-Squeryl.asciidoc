...
You want to write Specs2 unit tests that access your database model with Squeryl and Record.((("Record-Squeryl Lift applications", "testing with Specs", id="ix_RSLAtws", range="startofrange")))(((Specs2 unit tests)))(((unit tests, with Specs2)))
...
<<MongoUnitTest>> discusses unit testing with MongoDB, but the comments on SBT's other testing commands and testing in an IDE would apply to this recipe, too.(((range="endofrange", startref="ix_RSLAtws")))
