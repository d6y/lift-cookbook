...
You want to model a one-to-many relationship, such as a satellite belonging to a single planet, but a planet possibly having many satellites.(((Record-Squeryl Lift applications, one-to-many relationships in)))((("one-to-many relationships", id="ix_otmr", range="startofrange")))
...
Squeryl relations are documented at http://squeryl.org/relations.html[here].
