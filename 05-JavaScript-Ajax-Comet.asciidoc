...
You want a wired UI element to have a different format than plain conversion to a string. For example, you'd like to display a floating-point value as a currency.((("wired cells, formatting")))
