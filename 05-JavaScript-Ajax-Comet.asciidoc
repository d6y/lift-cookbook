...
Register a `String => JsCmd` function with `SHtml.ajaxSelect`.(((SHtml.ajaxSelect)))(((ajaxSelect)))(((JavaScript, server-side function triggering with)))((("String JsCmd function")))
