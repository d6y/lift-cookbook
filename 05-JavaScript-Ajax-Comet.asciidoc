...
You want to load an entire page--a template with snippets--inside of the current page (i.e., without a browser refresh).((("templates", "loading without browser refresh")))
