...
Register a `String => JsCmd` function with `SHtml.ajaxSelect`.(((SHtml.ajaxSelect)))(((ajaxSelect)))((("Ajax", "server-side code triggering")))(((JavaScript, server-side code triggering with)))((("String JsCmd function")))
